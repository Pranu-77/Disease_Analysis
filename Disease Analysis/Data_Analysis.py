...
def analysis():
        ...
        with open("C:/Users/upran/Desktop/Disease Analysis (PG Sem-2) P2/Scraped-Data/dataset_uncleaned.csv") as csvfile:
        ...
        with open("C:/Users/upran/Desktop/Disease Analysis (PG Sem-2) P2/Scraped-Data/dataset_clean.csv","w") as csvfile:
        ...
        data = pd.read_csv("C:/Users/upran/Desktop/Disease Analysis (PG Sem-2) P2/Scraped-Data/dataset_clean.csv",names=columns, encoding ="ISO-8859-1")         
        data.head()
